...
import { fetcherStats, httpAdmin } from '../utils/http'
import { MY_TEAM_ID, Player, PlayersMap } from '../utils/models'
...
const PlayersPage = () => {
  ...
  const saveMyPlayers = useCallback(async () => {
    await httpAdmin.put(`/my-teams/${MY_TEAM_ID}/players`, {
